...
export default function indexpage() {
  return (
     ...
     <header className="p-5 flex justify-between">
       ...
       <div className="flex gap-2 items-center border border-gray-300 rounded-full py-1 px-5 shadow-md shadow-gray-300">
         <div>Anywhere</div>
       ...
       <div className="flex items-center gap-2 border border-gray-300 rounded-full py-3 px-5 overflow-hidden">
